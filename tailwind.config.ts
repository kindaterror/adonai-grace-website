...
export default {
  ...
  // Preserve custom component classes (prefix `nc-`) that Tailwind's
  // purge/content scanner may not detect when built. This prevents
  // production builds from accidentally removing our handcrafted CSS.
  safelist: [
    { pattern: /^nc-/ },
  ],
  theme: {

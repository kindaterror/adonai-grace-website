...
export default function TeacherEditBook() {
  ...
  const onSubmit = async (data: EditBookFormValues) => {
    try {
      ...
      // flush child PageForm pending saves to get the freshest values
      ...
      for (const p of pages) {
        ...
        if (ref && ref.current && typeof ref.current.flush === 'function') {
          try {
            flushedPages.push(ref.current.flush());
            continue;
          } catch {
            // fall back to parent state for this page
          }
        }
        flushedPages.push(p);
      }
      ...
      >
        ...
        <div className="container mx-auto px-4 relative">
          ...
          <div className="mt-3 flex items-center justify-center text-[11px] text-blue-100/80 gap-2 font-sans font-bold">
            ...
            <span>›</span>
            <Link href="/teacher/books" className="hover:underline">Books</Link>
            <span>›</span>

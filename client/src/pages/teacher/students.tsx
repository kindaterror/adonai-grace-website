...
const coverFallbackForProgress = (progress: any) => {
  // prefer explicit book object cover
  const direct = getCoverUrl(progress.book, 56);
  if (direct) return direct;

  // If a slug is present, normalize and check the map directly
  ...
  // Heuristic matching by title keywords (covers the common cases)
